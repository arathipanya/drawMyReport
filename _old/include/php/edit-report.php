...
function addSelectGraph($graphs_array) {
  ...
  $str .= '</select></div><br><button class="btn btn-xs btn-primary add-graph-report" target="#select-graph-report-model-edit">Add a graph</button>';
  return $str;
}
...
?>
    <div class="input-group" id="select-graphs-list-report">
        ...
        <div class="form-control" id="select-graph-report-model-edit">
