...
function addSelectReport($graphs_array) {
  ...
  $str .= '</select></div><br><button class="xs-btn btn-default add-graph-report" target="#select-report-model">Add a report</button>';
  return $str;
}
?>
...
?>
    <div class="input-group-btn" id="select-graphs-list-report">
        <span class="input-group-addon">Users</span> <a href="#create-user-form" class="open-form">create / edit an user</a>
    ...
    <div class="input-group-btn" id="select-reports-list-email">
        <span class="input-group-addon">Reports</span>
        <div id="select-report-model">
